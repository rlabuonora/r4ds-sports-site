...
The script opens two rds files with data from NBA teams, merges on the `Team` column and calculates the mean assits, blocks, steals for the teams that went to the playoffs and the ones that did not. Finally, it creates an `html` table with the results.
