...
Use the [box.rds](./box.rds) to calculate the POSS factor for each team and list the 3 teams with higher possesion values in each conference. Create a version creating intermediate variables in each step and another version using the ` %>% `. Compare both approaches. 
